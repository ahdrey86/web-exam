...
def delete_review(review_id):
 ...
 import os
    ...
    print("=" * 60)
    print("🚀 Электронная библиотека успешно запущена!")
    print("📱 Откройте в браузере: http://localhost:5000")
    print("=" * 60)
    print("🔑 Тестовые аккаунты:")
    print("   👨‍💼 admin / password      (Администратор)")
    print("   👮‍♂️ moderator / password  (Модератор)")
    print("   👤 user1 / password      (Пользователь)")
    print("=" * 60)
    print("📚 Доступный функционал:")
    print("   ✅ Просмотр каталога книг")
    print("   ✅ Добавление/редактирование книг (админ)")
    print("   ✅ Удаление книг (админ)")
    print("   ✅ Система рецензий с модерацией")
    print("   ✅ Загрузка обложек книг")
    print("   ✅ Поддержка Markdown")
    print("   ✅ Пагинация и поиск")
    print("   ✅ Подборки книг (пользователи)")
    print("   ✅ Статистика просмотров (админ)")
    print("=" * 60)
